...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["CS", "UCS"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = r'E:\00_data\05-0507\data\infused\labels'  # 要转换的json文件所在目录
    resultDirPath = r'E:\00_data\05-0507\data\infused\labels'  # 要生成的txt文件夹
